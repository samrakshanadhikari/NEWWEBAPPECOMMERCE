            ...
            <div className="flex-1 p-6 md:p-8">
                    ...
                    <div className="mb-6">
                        ...
                        <div className="flex flex-col md:flex-row md:justify-between md:items-center">
                            ...
                            <div className="bg-blue-50 p-3 rounded-lg shadow-sm border border-blue-100">
                                <p className="text-xs text-blue-600 font-medium">Organized categories improve customer experience</p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="bg-blue-100 rounded-xl shadow-md overflow-hidden">
                    <div className="p-6 border-b border-blue-200">
                        <div className="flex items-center">
                            <FaLayerGroup className="h-5 w-5 text-blue-500 mr-3" />
                            <div>
                    ...
                    <form onSubmit={handleSubmit} className="p-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div className="md:col-span-1">
                                <div 
                                    className={`flex flex-col items-center bg-gray-50 rounded-lg p-6 border-2 border-dashed ${isDragging ? 'border-blue-500 bg-blue-50' : 'border-gray-300'} hover:border-blue-400 hover:bg-blue-50 transition-all transform hover:scale-[1.01] duration-200`}
                                    ...
                                    <div className="mt-2 w-full">
                                        <label className="block">
                                            ...
                                            <div className="flex flex-col items-center justify-center">
                                                ...
                                                <button
                                                    type="button"
                                                    className="inline-flex items-center px-4 py-2 bg-white border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-blue-50 hover:text-blue-600 hover:border-blue-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all"
                                                >
                                ...
                                <div className="space-y-6">
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative rounded-md shadow-sm">
                                            ...
                                            <input
                                                ...
                                                required
                                                className="pl-10 w-full py-3 px-4 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 shadow-sm"
                                                autoFocus
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-blue-50 rounded-lg p-4 shadow-sm border border-blue-100">
                                        <div className="flex">
                                            ...
                                            <div className="ml-3">
                                                <h3 className="text-sm font-medium text-blue-800">Category Best Practices</h3>
                        ...
                        <div className="mt-8 flex flex-col-reverse sm:flex-row sm:justify-end space-y-reverse space-y-4 sm:space-y-0 sm:space-x-4">
                            ...
                            <button
                                ...
                                className={`w-full sm:w-auto px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all transform hover:scale-[1.02] active:scale-[0.98] shadow-sm ${isSubmitting ? 'opacity-75 cursor-not-allowed' : ''}`}
                            >
